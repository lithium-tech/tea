...
$HMS_DIR/hive_metastore_client create-table 127.0.0.1 9090 test unsupported_historical_schema s3://warehouse/unsupported_historical_schema/metadata/00001-unsupported-historical-schema.metadata.json
